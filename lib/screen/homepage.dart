...
import 'openticket/tickets_screen.dart';
            ...
            if (snapshot.hasData) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  //   onTap: () {
                  //     ticket.addProductToCart(ticket.items[index]);
                  //     ticket.total();
                  //   },
                  //   child: Padding(
...
class AnimateItemList extends StatelessWidget {
  ...
  AnimateItemList({required this.onClick, required this.item});
  @override
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Provider.of<ItemsController>(context, listen: false).total();
      },
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16),
        child: Row(
